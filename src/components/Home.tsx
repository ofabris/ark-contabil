  ...
  return (
    <div className="home-container">
      ...
      <div className="home-content">
        <h1 className="text-3xl font-bold text-center text-custom-blue-dark mb-6">Welcome to Our Platform</h1>
        <div className="home-content-inner">
          <p className="text-center mb-6">This is the main page of our application.</p>
        </div>
      </div>
    </div>
  );
